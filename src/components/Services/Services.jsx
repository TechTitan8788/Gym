  ...
  const services = [
    {
      ...
      description: "Customized weight training programs with expert guidance to build muscle and power.",
      features: ["Personalized plans", "Premium equipment", "Progress tracking"],
      bgColor: "bg-orange-100"
    },
    {
      icon: <FaRunning className="text-4xl" />,
      title: "Cardio Programs",
      description: "High-energy workouts to boost endurance and burn calories effectively.",
    ...
    },
    {
      ...
      title: "Group Classes",
      description: "Motivating group sessions for all fitness levels in various disciplines.",
    ...
    },
    {
      ...
      description: "One-on-one coaching with certified trainers for maximum results.",
    ...
    },
    {
      ...
      title: "24/7 Access",
      description: "Flexible gym access to fit your schedule anytime, day or night.",
    ...
    <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Transform Your <span className="text-orange-600">Fitness Journey</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Premium services designed to help you achieve your goals faster and more effectively
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className={`w-16 h-16 ${index % 2 === 0 ? 'bg-orange-500' : 'bg-gray-800'} rounded-full flex items-center justify-center mb-6 text-white`}>
                {service.icon}
              </div>
